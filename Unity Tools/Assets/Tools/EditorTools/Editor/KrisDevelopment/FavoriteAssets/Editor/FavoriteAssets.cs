       ...
       DataWrapper assetsData
        ...
        public void OnGUI () 
        {
            ...
            GUILayout.BeginHorizontal(EditorStyles.toolbar);
            {
                ...
                if(GUILayout.Button("Save All Comments", EditorStyles.toolbarButton)){
                        SaveData();
                }
            }
            ...
            foreach(AssetData assetData in assetsData.assets) {
                ...
                assetData.alias  = EditorGUILayout.TextField(new GUIContent(), assetData.alias, GUILayout.ExpandWidth(false));
